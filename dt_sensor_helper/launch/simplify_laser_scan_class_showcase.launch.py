...
def generate_launch_description():
    ...
    simplify_laser_scan_class_showcase_node = Node(
        package="dt_sensor_helper",
        executable="simplify_laser_scan_class_showcase_node",
        name="simplify_laser_scan_class_showcase_node",
        output="screen"
    )
    ...
    return LaunchDescription(
        [
            gz_sim,
            rosbot2_sim,
            simplify_laser_scan_class_showcase_node
        ]
    )